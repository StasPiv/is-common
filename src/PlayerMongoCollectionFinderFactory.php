...
class PlayerMongoCollectionFinderFactory implements Contract\CollectionFinderFactoryInterface
{
    ...
    {
        return new PlayerMongoCollectionFinder($this->mongoDatabaseFactory->createDatabase());
    }
}