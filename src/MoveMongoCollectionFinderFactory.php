...
class MoveMongoCollectionFinderFactory implements Contract\CollectionFinderFactoryInterface
{
    ...
    {
        return new MoveMongoCollectionFinder($this->mongoDatabaseFactory->createDatabase());
    }
}
